...
# save results
np.savez(
    "output/search-compression-vanilla_model.npz",
...
def grouped_box_plot(compression_rates, _30aucs_over_compression_rate):
    ...
    plt.savefig("output/search-compression-vanilla_model.svg")

grouped_box_plot(compression_rates, _30aucs_over_compression_rate)
